...
public class EntityView extends FrameLayout {
    ...
    public EntityView(Context context, Point2 pos) {
        super(context);
    ...
    public void setPosition(Point2 value) {
        position = value;
        updatePosition();
    }
    ...
    private boolean onTouchMove(float x, float y) {
        ...
        Point2 translation = new Point2((x - previousLocationX) / scale, (y - previousLocationY) / scale);
    ...
    public void pan(Point2 translation) {
            ...
            switch (action) {
                ...
                case MotionEvent.ACTION_MOVE: {
                    if (currentHandle == SELECTION_WHOLE_HANDLE) {
                        ...
                        Point2 translation = new Point2(event.getRawX() - previousLocationX, event.getRawY() - previousLocationY);
